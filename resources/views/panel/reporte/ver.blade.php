...
@section('container')
    ...
    <div class="col-md-8">
    <div class="card-body">
    <h5 class="card-title">{{$usuario->name}} {{$usuario->apellidos}} </h5> <a class="btn-sm btn btn-danger" href="{{route('reporte')}}"><i class="fas fa-undo-alt"></i> Regresar</a> 
    ...
    <ul class="list-group hover">
     ...
     <li class="list-group-item">Rol : {{ $value }}</li> 
